...
2. V kompaktnom pracovnom priestore sú stopa videa A1 a hudba A2 priamo pod sebou. Na farebnom waveforme alebo spektrograme nastavte trim, začiatok reči, koniec „Give Me Five“, začiatok druhej reči a koniec hovoreného slova.
   - Rýchla kontrola značiek prejde všetkých šesť bodov v poradí. Každý bod môžete vypočuť v automatickej slučke a doladiť o 0,1 s bez presúvania playheadu a opakovaného klikania.
...
8. Tlačidlo **Prehrať mix** prehráva priebežne aktuálny finálny zvuk: rovnaký DeepFilterNet3 hlas ako export, hudbu s automatickým stíšením, whoosh +5 dB a záverečný fade. Slučky **Úvod**, **Počas reči**, **Drop** a **Záver** pokračujú aj počas posúvania hlasitostí. Aktívna hudobná úroveň sa zvýrazní a každý režim má vlastné tlačidlo ▶.
